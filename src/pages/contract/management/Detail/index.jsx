            ...
            <div className="bg">
                <Descriptions bordered className="descriptions">
                    ...
                    <Descriptions.Item label="支付方式"
                                       span={1.5}>{contractDetail.paymentType === 1 ? '现结' : (contractDetail.paymentType === 2 ? '账期' : '年结')}</Descriptions.Item>
                    <Descriptions.Item label="项目金额" span={1.5}>{contractDetail.projectMoney}</Descriptions.Item>
                    <Descriptions.Item label="乙方是否包备品备件"
                                       span={1.5}>{contractDetail.isSparePart === 0 ? "不包括" : "包括"}</Descriptions.Item>
                    <Descriptions.Item label="乙方是否提供备品备件替换服务"
                                       span={1.5}>{contractDetail.isSpareService === 0 ? "不提供" : "提供"}</Descriptions.Item>
                    <Descriptions.Item label="维修维护最迟响应时间（小时）"
                                       span={1.5}>{contractDetail.lastResponseTime}</Descriptions.Item>
                    ...
                    <Descriptions.Item label="附件下载链接">{urlList}</Descriptions.Item>
